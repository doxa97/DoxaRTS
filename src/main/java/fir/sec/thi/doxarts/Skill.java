            ...
            if (player.getInventory().getItem(0).getItemMeta().getLore().contains("[ 무기 ]")) {
                ...
                for (int i = 0; i <= lore.size(); i++){
                    ...
                    if (lore.get(i).contains("[ 대검 기본 공격 ]")){
                        lore.set(i+1,"기본 공격 피해량 : "+ weapon.get(name+"meleeattack"));
                    ...
                    if (lore.get(i).contains("[ 마법 바람 기본 공격 ]")){
                        lore.set(i+1,"기본 공격 피해량 : "+ weapon.get(name+"magicattack"));
                    ...
                    if (lore.get(i).contains("[ 올려 베기 ]")){
                        lore.set(i+1,"올려 베기 피해량 : "+ String.format("%.2f",weapon.get(name+"meleeattack") * 0.85));
                    ...
                    if (lore.get(i).contains("[ 십자 베기 ]")){
                        lore.set(i+1,"십자 베기 피해량 : "+ String.format("%.2f",weapon.get(name+"meleeattack") * 0.6));
                        lore.add(i+2,"십자 형태로 전방을 베어내어 2회 피해를 입히는 기술이다.");
                        lore.add(i+3,"4블럭 전방을 베어낸다. 재사용 대기시간 : 13 초");
                    }
                    if (lore.get(i).contains("[ 연격 ]")){
                        lore.set(i+1,"연격 피해량 : "+ String.format("%.2f",weapon.get(name+"meleeattack") * 0.9));
                    ...
                    if (lore.get(i).contains("[ 참격 ]")){
                        lore.set(i+1,"참격 피해량 : "+ (weapon.get(name+"meleeattack") + weapon.get(name+"magicattack")));
                    ...
                    if (lore.get(i).contains("[ 포효 ]")){
                        lore.set(i+1,"포효 피해량 : "+ ((weapon.get(name+"meleeattack") * 0.4) + (weapon.get(name+"magicattack") * 0.4)));
                    ...
                    if (lore.get(i).contains("[ 후퇴 ]")){
                        lore.set(i+1,"후퇴 피해량 : "+ String.format("%.2f",weapon.get(name+"meleeattack") * 0.45));
                    ...
                    if (lore.get(i).contains("[ 선풍 ]")){
                        lore.set(i+1,"선풍 피해량 : "+ String.format("%.2f",weapon.get(name+"magicattack") * 1.3));
                    ...
                    if (lore.get(i).contains("[ 속사 ]")){
                        lore.set(i+1,"속사 피해량 : "+ String.format("%.2f",weapon.get(name+"meleeattack") * 0.7));
                        lore.add(i+2,"일반 공격 시, 같은 궤적으로 2발의 화살을 추가로 사격합니다.");
                        lore.add(i+3,"10초 동안 유지됩니다. 재사용 대기시간 : 40 초");
                    }
                    if (lore.get(i).contains("[ 추격 ]")){
                        lore.set(i+1,"추격 피해량 : "+ String.format("%.2f",(weapon.get(name+"meleeattack") * 0.3) + (weapon.get(name+"magicattack") * 0.3)));
                    ...
                    if (lore.get(i).contains("[ 고통의 대지 ]")){
                        lore.set(i+1,"고통의 대지 피해량 : "+ String.format("%.2f",weapon.get(name+"magicattack") * 0.12));
                    ...
                    if (lore.get(i).contains("[ 속죄 ]")){
                        lore.set(i+1,"속죄 패해량 : "+ String.format("%.2f",weapon.get(name+"magicattack") * 1.3));
                    ...
                    if (lore.get(i).contains("[ 검은 손짓 ]")){
                        lore.set(i+1,"검은 손짓 피해량 : "+ String.format("%.2f",weapon.get(name+"magicattack") * 1.25));
                    ...
                    if (lore.get(i).contains("[ 서릿발 ]")){
                        lore.set(i+1,"서릿발 피해량 : "+ String.format("%.2f",weapon.get(name+"magicattack") *0.8));
                    ...
                    if (lore.get(i).contains("[ 화염 ]")){
                        lore.set(i+1,"화염 피해량 : "+ String.format("%.2f",weapon.get(name+"magicattack")*0.1));
                        lore.add(i+2,"알으로 화염을 내뱉어 지속적인 피해를 입힙니다.");
                        lore.add(i+3,"1.5초 동안 지속되며, 총 15회 피해를 입힙니다. 재사용 대기시간 : 18 초");
                    }
                    if (lore.get(i).contains("[ 서리 지대 ]")){
                        lore.set(i+1,"서리 지대 피해량 : "+ String.format("%.2f",weapon.get(name+"magicattack") * 0.08));
