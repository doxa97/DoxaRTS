    ...
    public void onEnable() {
        ...
        getServer().getScheduler().scheduleSyncRepeatingTask(this, () -> {
            ...
            for (Player player : getServer().getOnlinePlayers()) {
                ...
                BaseStat.BaseStatSetting(player);
                ...
                Objects.requireNonNull(player.getAttribute(Attribute.GENERIC_ATTACK_SPEED)).setBaseValue((double) weapon.get(name+"attackspeed"));
                Objects.requireNonNull(player.getAttribute(Attribute.GENERIC_MOVEMENT_SPEED)).setBaseValue((base.get(name+"movement") + stat[11])/100);
                Objects.requireNonNull(player.getAttribute(Attribute.GENERIC_MAX_HEALTH)).setBaseValue(base.get(name+"health") + stat[9]);
            }
        },0,0);
    }
